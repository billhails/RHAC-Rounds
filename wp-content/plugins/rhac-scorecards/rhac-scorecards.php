...
wp_enqueue_script('rhac_scorecards', plugins_url('scorecard.js', __FILE__), array('jquery', 'jquery-ui-datepicker'));
...
function rhac_admin_css() {
    wp_enqueue_style('rhac_scorecard_style', plugins_url('scorecard.css', __FILE__));
    wp_enqueue_style('rhac_jquery_ui', plugins_url('jquery-ui.css', __FILE__));
    wp_enqueue_style('rhac_jquery_ui_all', plugins_url('jquery.ui.all.css', __FILE__));
    wp_enqueue_style('rhac_jquery_ui_core', plugins_url('jquery.ui.core.css', __FILE__));
    wp_enqueue_style('rhac_jquery_ui_datepicker', plugins_url('jquery.ui.datepicker.min.css', __FILE__));
}
